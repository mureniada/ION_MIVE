...
Independence invariant: this adapter receives ONLY the already-governed
`ModelContextAssembly` for this turn (TASK 19.3) — never the upstream
`ContextPack`, and never any Gemini output (docs/05). It imports no
governance, admission, retrieval, Core Adapter, Turn Record or Response
Evidence type: the input it is given here is already authorized before it
